...
var test_terrain2_ : PackedScene = load("res://Levels/TestTerrain2/Scenes/TestTerrain2.tscn")
var new_canyon_ : PackedScene = load("res://Levels/NewCanyon/Scenes/NewCanyon.tscn")
