...
var test_track_ : PackedScene = load("res://Levels/TestTrack/SinglePlayerTestTrack.tscn")
var test_terrain_ : PackedScene = load("res://Levels/TestTerrain/SinglePlayerTestTerrain.tscn")
...
#const DEFAULT_SFX_LEVEL : int = -25
const DEFAULT_SFX_LEVEL : int = -48
#const DEFAULT_MUSIC_LEVEL : int = -25
